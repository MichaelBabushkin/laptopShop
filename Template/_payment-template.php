                            ...
                            <form role="form">
                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        <div class="form-group"> <label><span class="hidden-xs">
                                            ...
                                            <div class="input-group"> <input type="number" min=1 max=12 placeholder="MM"
                                                    name="" class="form-control" required> <input type="number" min=0
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group mb-4"> <label data-toggle="tooltip"
                                            ...
                                            </label> <input type="text" required class="form-control" placeholder="CVV">
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    ...
                                    <button type="button" class="subscribe btn btn-primary btn-block shadow-sm"
                                        data-toggle="modal" data-target="#modalSubscriptionForm"> Confirm Payment
                                    </button>
                            </form>
                        </div>
                    </div> <!-- End -->
                        ...
                        <div class="modal-dialog " role="document">
                            <div class="modal-content mt-5 ">
                                <div class="modal-header text-center bg-success ">
                                    <h4 class="modal-title w-100 font-weight-bold">Confirmed</h4>
                                </div>
                                <div class="modal-body mx-3">
                                    <div class="md-form mb-2">
                                        <label data-error="wrong" data-success="right" for="form3">Your purchase was
                                            approved! &nbsp <i class="fas fa-check-circle"></i> </label>
                                    </div>
